<div class="">
    <div class="flex gap-4 pb-4 border-b border-gray-600 ">
        <div class="flex flex-col justify-end">
            <h1 class="font-bold text-lg pb-2">Navigate</h1>
        </div>
        <x-text-input class="block mt-1 w-full" wire:model.live='search' placeholder="search document" autocomplete="password" />
    </div>
